...
typealias APIServiceFailureCallback2 = ((Error?) -> ())
...
public class Indicator {
    ...
    var customIndicator = UIActivityIndicatorView()
    ...
    private init() {
        ...
        imageView.alpha = 0.5
        customIndicator.style = .whiteLarge
        customIndicator.center = imageView.center
        customIndicator.startAnimating()
        customIndicator.color = UIColor(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 1.0)
